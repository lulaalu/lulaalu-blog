								...
								{group.items.map(it => {
									...
									return (
										<Link
											...
											<span className={cn('text-secondary shrink-0 text-sm font-medium', displayMode === 'category' ? 'w-[64px]' : 'w-[44px]')}>
												{dayjs(it.date).format(displayMode === 'category' ? 'YY-MM-DD' : 'MM-DD')}
											</span>
